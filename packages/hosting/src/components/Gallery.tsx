...
const GridConetnt: FC<ContentProps> = ({ href, imgSrc, imgAlt, text, isExternal = false }) => (
  ...
  >
    ...
    <span className="inline-block text-white text-sm md:text-lg relative ml-4 md:ml-5 mb-3">{text}</span>
  </a>
);
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 xl:gap-8 mb-4 md:mb-8">
        <GridConetnt href="https://ixanary.com" imgSrc={url} imgAlt={name} text="Top" isExternal />
        <GridConetnt
