export const Banners: readonly Record<"title" | "src", string>[] = [
  {
    title: "",
    src: "https://rcm-fe.amazon-adsystem.com/e/cm?o=9&p=12&l=ur1&category=newlifestore&banner=16ZPC5PK0X63TGJERE82&f=ifr&linkID=3f80c35d206129f883480b5efc1e1bbd&t=ixanary-uploader-22&tracking_id=ixanary-uploader-22"
  },
  {
